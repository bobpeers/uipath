...
def run_inference_on_image(image,Numpredictions):
  ...
  with tf.Session() as sess:
    ...
    top_k = predictions.argsort()[-int(Numpredictions):][::-1]
...
#get predictions
def main(image,Numpredictions):
  returnValue=run_inference_on_image(image,Numpredictions)
  return(returnValue)
